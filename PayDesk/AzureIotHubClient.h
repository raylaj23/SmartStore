...
#else // pentru ESP32 Arduino v2.x
...
static void generateTelemetryPayload(String body)
{
  ...
  telemetry_payload = "{ \"virtual_basket\": " + body + " }";
}

static void sendTelemetry(String body)
{
